...
\centering
\includegraphics[width=\textwidth,trim=0in 0in 0in 0in,clip]{./figures/GASP/counter-examples/counter-example-GAEC.pdf}
...
% \begin{subfigure}[t]{0.48\textwidth}
\centering
\includegraphics[width=\textwidth,trim=0in 0in 0in 0in,clip]{./figures/GASP/counter-examples/counter-example.pdf}
% \caption{Original graph and dendrogram}
% \end{subfigure}
